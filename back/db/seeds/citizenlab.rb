...
AppConfiguration.create!(
  ...
  settings: {
    core: {
      allowed: true,
      enabled: true,
      locales: [ENV.fetch('CL_SETTINGS_CORE_LOCALES_0', 'fr')],
      organization_type: 'small_city',
      organization_name: {
        'fr' => Faker::Address.city,
      },
      timezone: ENV.fetch('CL_SETTINGS_CORE_TIMEZONE', 'UTC'),
      currency: ENV.fetch('CL_SETTINGS_CORE_CURRENCY', 'XOF'),
      color_main: '#163A7D',
...
User.create!(
  ...
  locale: ENV.fetch('CL_SETTINGS_CORE_LOCALES_0', 'fr'),
